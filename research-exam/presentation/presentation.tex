...
\newcommand{\tick}[2]{\draw[xshift=#1cm,yshift=#2cm] (0,-2pt) -- (0,2pt);}
\newcommand{\widebraceabove}[4]{\draw [decorate,decoration={brace,amplitude=10pt},yshift=5pt] (#1,#3) -- (#2,#3) node [midway,yshift=17pt] {#4};}
\newcommand{\widebracebelow}[4]{\draw [decorate,decoration={brace,amplitude=10pt},yshift=-5pt] (#2,#3) -- (#1,#3) node [midway,yshift=-17pt] {#4};}
...
\onslide<+->{(\alert<.| handout:0>{$\eta(\theta) =$ \emph{natural parameters}}, \alert<+| handout:0>{$T(x) =$ \emph{sufficient statistics}})}
...
\draw (0,0) -- (10,0);
\widebraceabove{0}{10}{0}{$1$}
\tick{0}{0}
\tick{10}{0}
\onslide<+->
\tick{3}{0}
\widebracebelow{0}{3}{0}{$V_1$}
\widebracebelow{3}{10}{0}{$1-V_1$}

\onslide<+->
\draw[dashed] (3,0) -- (3,-1.5);
\draw[dashed] (10,0) -- (10,-1.5);
\draw (3,-1.5) -- (10,-1.5);
\tick{3}{-1.5}
\tick{10}{-1.5}
\tick{6}{-1.5}
\widebracebelow{3}{6}{-1.5}{$(1-V_1)V_2$}
\widebracebelow{6}{10}{-1.5}{$(1-V_1)(1-V_2)$}
...
\tick{10}{-3}
\tick{8}{-3}
\widebracebelow{6}{8}{-3}{{$(1-V_1)(1-V_2)V_3$}}
...
% \begin{frame}
% \frametitle{CRP: Stick-Breaking Construction}
% \begin{center}
% \begin{tikzpicture}
% \node (start) {};
...
\item For each document $d$:
    ...
    \item Draw a stick-breaking distribution over depths $\phi_d$
...
Visualizing $V^d_{r,j}$ and $U^d_r$, ignoring branch permutations \\ (i.e., assuming $z^d_{r,j} = j$) \\
