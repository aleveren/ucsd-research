...
% TODO: include algorithm listing for Gibbs (just 1 algo, general enough to apply to collapsed or traditional?)
...
% TODO: need to discuss exponential family & conjugate priors here?  or point to reference?  or add forward pointer?
...
% TODO: need to define suff.stats and nat.params
...
% TODO: algorithm listing for SVI
...
% We will see that Bayesian non-parametric models, which involve latent variables drawn from infinite dimensional spaces, require special handling.
...
% TODO: add figure from NHDP paper (with citation), and reference it in preceding discussion
