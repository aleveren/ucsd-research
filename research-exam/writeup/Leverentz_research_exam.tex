...
% Since this process does not directly estimate the posterior distribution over some of the latent variables, additional post-processing steps are necessary to obtain estimates for the omitted latent variables.
