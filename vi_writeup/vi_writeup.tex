...
\begin{align}
J
&= C' + \log r_{c_i} - \frac{1}{2} \log \abs{ \Sigma_{c_i} } - \frac{1}{2} (x_i - \mu_{c_i})^\top \Sigma_{c_i}^{-1} (x_i - \mu_{c_i}) \\
&= C' + \log r_{c_i} - \sum_{\ell=1}^d \left(
    \log \sigma_{c_i, \ell} - \frac{\sigma_{c_i, \ell}^{-2}}{2}
        \left[
            x_{i,\ell}^2 - 2 x_{i,\ell} \mu_{c_i,\ell} + \mu_{c_i,\ell}^2
        \right]
    \right)
\end{align}
