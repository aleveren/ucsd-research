...
% TODO: probably need to discuss Aho's algorithm and triplet constraints somewhere in more detail
...
% Similarly, this difference can get arbitrarily close to $0$ if we violate the $\deltaMin$ bound, by holding $x$ fixed and letting $y$ approach $x/2$ from above.
